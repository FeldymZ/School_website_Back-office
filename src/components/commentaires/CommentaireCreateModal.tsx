...
import { X, Image as ImageIcon, Upload, Loader, Sparkles, MessageSquare } from "lucide-react";
...
export default function CommentaireCreateModal({ onClose, onCreated }: Props) {
  ...
  const handleSubmit = async () => {
    if (!authorName || !content || !displayDate || !authorImage) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="create-commentaire-title"
        style={{
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain">
          <div className="p-4 sm:p-8 space-y-5 sm:space-y-6">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-gray-700">
                <MessageSquare size={14} className="text-[#00A4E0] flex-shrink-0" />
                  ...
                  <div className="relative overflow-hidden border-2 border-dashed border-[#00A4E0]/30 rounded-xl p-6 sm:p-12 text-center bg-gradient-to-br from-[#cfe3ff]/20 to-transparent hover:border-[#00A4E0] hover:bg-[#cfe3ff]/30 active:bg-[#cfe3ff]/40 transition-all">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-[11px] sm:text-xs text-[#A6A6A6] mt-2">
                        PNG, JPG, WEBP jusqu'à {MAX_IMAGE_MB}MB
                      </p>
                    </div>
                  </div>
                </label>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] sm:text-xs text-[#A6A6A6]">
                    Le commentaire sera visible sur le site
                  </p>
                </div>
              </div>
            </button>
        ...
        >
          ...
          <button
            ...
            disabled={!authorName || !content || !displayDate || !authorImage || loading}
