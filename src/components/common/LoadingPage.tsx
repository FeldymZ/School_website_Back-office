    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white relative overflow-hidden px-4">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-sm">
        ...
        <div className="mb-10 sm:mb-16">
          <h1
            className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-widest min-h-[44px] sm:min-h-[80px] flex items-center justify-center text-center"
            style={{ color: '#00A4E0' }}
          >
            {displayText}
            ...
            return (
              <div key={i} className="flex items-center">
                ...
                <div className="relative flex flex-col items-center">
                  <div
                    className="relative w-12 h-12 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center transition-all duration-500"
                    style={{
                      background: isActive
                      ...
                      boxShadow: isActive
                        ? '0 10px 24px -8px rgba(0, 164, 224, 0.55)'
                        : 'none',
                  ...
                  >
                    ...
                    {isCurrent && (
                      <>
                        ...
                        />
                        <div
                          className="absolute -inset-1.5 rounded-2xl border-2 animate-ping"
                ...
                {i < ICONS.length - 1 && (
                  <div className="relative w-6 sm:w-9 h-0.5 mx-1 sm:mx-1.5">
                    <div
        ...
        <span
          className="text-xs sm:text-sm tracking-[0.2em] uppercase mb-8 sm:mb-12 font-medium"
          style={{ color: '#A6A6A6' }}
        >
        ...
        <div className="w-full max-w-[220px] sm:max-w-xs space-y-3 sm:space-y-4 mb-6 sm:mb-10">
          {/* Barre 1 — CPU */}
          <div className="relative h-6 sm:h-8 rounded-full bg-gray-100 border border-gray-200 overflow-hidden">
            <div
            ...
            <div
              className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-5 h-5 sm:w-7 sm:h-7 rounded-full bg-white shadow-md border-2 flex items-center justify-center transition-all duration-300 ease-out"
              style={{
                left: `${progress}%`,
                borderColor: '#00A4E0',
              }}
            >
              <Cpu size={10} className="sm:hidden" style={{ color: '#00A4E0' }} />
          ...
          <div className="relative h-6 sm:h-8 rounded-full bg-gray-100 border border-gray-200 overflow-hidden">
            ...
            >
              <Server size={10} className="sm:hidden" style={{ color: '#0090C8' }} />
        ...
        <div className="animate-fade-in-bottom">
          <h2
            className="text-xl sm:text-2xl lg:text-3xl font-semibold tracking-wider text-center"
            style={{ color: '#A6A6A6' }}
          >
