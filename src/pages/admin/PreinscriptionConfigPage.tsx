...
const PreinscriptionConfigPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 p-4 sm:p-6 space-y-8 animate-in fade-in duration-500">
      ...
      {/* ── TABS ── */}
      <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-white shadow-lg p-2 grid grid-cols-1 sm:grid-cols-3 gap-2">
        {([
        ...
        <Modal title="Modifier la période de demandes" color="from-purple-500 to-indigo-600"
          ...
          <div className="space-y-3">
            <input type="datetime-local" value={editPeriode.dateDebut}
              ...
              className={inputCls} />
            <input type="datetime-local" value={editPeriode.dateFin}
        ...
        <Modal title="Modifier l'émetteur" color="from-orange-400 to-amber-500"
          ...
          <div className="space-y-3">
            <input value={editEmetteur.nom}
              ...
              className={inputCls} placeholder="Nom de l'émetteur" />
            <input value={editEmetteur.fonction}
              onChange={e => setEditEmetteur({ ...editEmetteur, fonction: e.target.value })}
              className={inputCls} placeholder="Fonction" />
            <label className="flex items-center gap-2.5 px-4 py-3 rounded-xl border-2 border-dashed border-gray-200 hover:border-orange-400 hover:bg-orange-50/30 transition-all cursor-pointer group">
              <ImagePlus size={16} className="text-gray-400 group-hover:text-orange-500 transition-colors flex-shrink-0" />
              <span className="text-sm text-gray-500 group-hover:text-orange-600 truncate">
