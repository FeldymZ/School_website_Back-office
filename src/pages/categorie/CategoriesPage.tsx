          ...
          <div className="relative z-10">
            <div className="w-14 h-14 sm:w-20 sm:h-20 mx-auto mb-5 sm:mb-6 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Tag className="w-7 h-7 sm:w-10 sm:h-10 text-white animate-bounce" />
              </div>
            </div>
            <div className="inline-flex items-center gap-2.5 sm:gap-3 text-[#00A4E0]">
              ...
              <span className="text-sm sm:text-lg font-semibold">Chargement des catégories...</span>
            </div>
      ...
      <div className="w-full space-y-5 sm:space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="relative group flex-shrink-0">
                ...
                <div className="relative w-11 h-11 sm:w-16 sm:h-16 bg-gradient-to-br from-[#00A4E0] to-[#0077A8] rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg">
                  <Tag className="w-5 h-5 sm:w-8 sm:h-8 text-white" />
                </div>
              </div>
        ...
        {categories.length === 0 && (
          <div className="bg-white rounded-2xl sm:rounded-3xl p-8 sm:p-16 text-center space-y-5 sm:space-y-6 border border-gray-100 shadow-xl">
            ...
            <div className="space-y-2">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-900">Aucune catégorie</h3>
              <p className="text-gray-600 max-w-sm mx-auto text-sm sm:text-base px-4">
        ...
        {categories.length > 0 && (
          <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden border border-gray-100 shadow-lg">
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <span className="text-[11px] sm:text-xs font-bold text-gray-700 uppercase tracking-wider">Libellé</span>
                <span className="text-[10px] font-bold text-[#00A4E0] bg-[#cfe3ff]/50 px-1.5 py-0.5 rounded-md border border-[#00A4E0]/20">
                  A→Z
                </span>
              </div>
              <span className="text-[11px] sm:text-xs font-bold text-gray-700 uppercase tracking-wider">Actions</span>
            </div>
            ...
            <div className="divide-y divide-gray-100">
              {categories.map((c, index) => (
                <div
                  key={c.id}
                  className="group flex items-center justify-between gap-2 px-4 sm:px-6 py-3.5 sm:py-4
                ...
                >
                  <div className="flex items-center gap-2.5 sm:gap-3 flex-1 min-w-0 mr-2 sm:mr-4">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-gradient-to-br from-[#00A4E0] to-[#0077A8] flex items-center justify-center shadow-sm flex-shrink-0">
                    ...
                    {editingId === c.id ? (
                      <input
                        ...
                        autoFocus
                        className="flex-1 min-w-0 px-3 py-2 rounded-xl border border-[#00A4E0] bg-blue-50/50
                    ...
                    {editingId === c.id ? (
                      <>
                        <button
                          ...
                          className="min-h-[40px] min-w-[40px] flex items-center justify-center rounded-xl text-gray-600 hover:text-green-600
                                     hover:bg-green-50 active:bg-green-100 transition-all duration-200 sm:hover:scale-110 active:scale-95"
                          title="Confirmer"
                        >
                          <Check size={16} />
                        </button>
                        <button
                          ...
                          className="min-h-[40px] min-w-[40px] flex items-center justify-center rounded-xl text-gray-600 hover:text-gray-800
                                     hover:bg-gray-100 active:bg-gray-200 transition-all duration-200 sm:hover:scale-110 active:scale-95"
                          title="Annuler"
                        >
                          <X size={16} />
                        </button>
                      ...
                      <>
                        <button
                          ...
                          className="min-h-[40px] min-w-[40px] flex items-center justify-center rounded-xl text-gray-600 hover:text-[#00A4E0]
                                     hover:bg-blue-50 active:bg-blue-100 transition-all duration-200 sm:hover:scale-110 active:scale-95"
                          title="Modifier"
                        >
                          <Pencil size={16} />
                        </button>
                        <button
                          ...
                          className="min-h-[40px] min-w-[40px] flex items-center justify-center rounded-xl text-gray-600 hover:text-red-600
                                     hover:bg-red-50 active:bg-red-100 transition-all duration-200 sm:hover:scale-110 active:scale-95"
                          title="Supprimer"
                        >
                          <Trash2 size={16} />
                        </button>
